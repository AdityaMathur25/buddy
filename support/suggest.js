...
module.exports = {
    ...
    description: "suggest something to your server",
  category: "support",
...
.setTimestamp()
.setColor("RED")
.setFooter("From: " + message.author.username +" | Server: " + message.guild.name)
  if(!command) return message.channel.send(wrong)
